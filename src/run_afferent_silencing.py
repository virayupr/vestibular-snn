...
# Remove effective input→afferent drive
syn_in_aff = Synapses(input_layer, afferent, on_pre='v_post += 0*mV'); syn_in_aff.connect(j='i')
...
run(duration)
print("Afferent Silencing → Input:", M_in.num_spikes, "Afferent:", M_aff.num_spikes, "Cerebellar:", M_cer.num_spikes)
