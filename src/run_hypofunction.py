...
n_input = 10
input_layer = PoissonGroup(n_input, rates=15*Hz)  # reduced input
...
run(duration)
print("Hypofunction → Input:", M_in.num_spikes, "Afferent:", M_aff.num_spikes, "Cerebellar:", M_cer.num_spikes)
